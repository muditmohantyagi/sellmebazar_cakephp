...
<head>
    ...
    <![endif]-->
 <?php echo $this->Html->css(array('bootstrap.min','style','modern-business','font-awesome.min','cake')) ?>
 <?php echo $this->Html->css(array('validation_engine/validationEngine.jquery')) ?>
 <?php echo $this->Html->script(array('jquery','bootstrap.min')) ?>
 <?php echo $this->Html->script(array('validation_engine/languages/jquery.validationEngine-en','validation_engine/jquery.validationEngine')) ?>
    <?= $this->fetch('meta') ?>
    <?= $this->fetch('css') ?>
    <?= $this->fetch('script') ?>
</head>
